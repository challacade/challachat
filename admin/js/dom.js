...
export const textShadowSlider  = $('textShadowSlider');
export const textShadowLabel   = $('textShadowLabel');
...
export const textureGapSlider        = $('textureGapSlider');
export const textureGapLabel         = $('textureGapLabel');
// Sound
...
export const musicProgressBar  = $('musicProgressBar');
export const musicTimeCurrent  = $('musicTimeCurrent');
export const musicTimeTotal    = $('musicTimeTotal');
export const musicVolSlider    = $('musicVolSlider');
export const musicVolLabel     = $('musicVolLabel');
export const musicVolIcon      = $('musicVolIcon');
export const musicPanSlider    = $('musicPanSlider');
